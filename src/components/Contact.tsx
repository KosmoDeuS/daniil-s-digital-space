  ...
  return (
    <section id="contact" className="py-24 px-6" ref={ref}>
      <div className="max-w-xl mx-auto text-center">
        <h2 className="font-mono-display text-sm text-primary mb-2 tracking-wider uppercase">Contact</h2>
        <h3 className="text-3xl sm:text-4xl font-bold mb-4">Let's connect</h3>
