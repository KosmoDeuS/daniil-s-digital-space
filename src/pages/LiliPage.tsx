...
const LiliPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{ background: 'radial-gradient(ellipse at center, hsl(0 0% 2%) 0%, hsl(0 0% 2%) 35%, hsl(350 65% 15%) 70%, hsl(345 60% 20%) 100%)' }}>
      <PinkParticles />
